 ...
 * @author USER
 */
public class vsbot4 extends javax.swing.JFrame {
    ...
    public vsbot4(int movecount, int timer) {
        initComponents();
        startTimer();
        if (movecount == 0){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vsbot4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
