 ...
 * @author USER
 */
public class vsbot3 extends javax.swing.JFrame {
    ...
    int elapsedTime = 0;
    /**
     * Creates new form vsbot3
     */
    public vsbot3() {
        initComponents();
        startTimer();
    }
    public vsbot3(int movecount, int timer) {
        initComponents();
        startTimer();
        if (movecount == 0){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vsbot3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
